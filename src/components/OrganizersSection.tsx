          ...
          <div className="bg-white rounded-2xl p-12 shadow-lg">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                "Unidos pela paixão por um estilo de vida saudável e ativo, criamos o Wake & Move 
                para conectar pessoas que acreditam no poder transformador do movimento. Cada evento 
                é uma oportunidade de crescimento, superação e construção de uma comunidade mais forte 
                e saudável."
              </p>
              
              <div className="flex justify-center gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#9CBE31] mb-1">2+</div>
                  <div className="text-sm text-gray-600">Anos de Experiência</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#9CBE31] mb-1">100+</div>
                  <div className="text-sm text-gray-600">Vidas Impactadas</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#9CBE31] mb-1">1</div>
                  <div className="text-sm text-gray-600">Comunidade Unida</div>
                </div>
              </div>
            </div>
          </div>
